...
class CvColorFill:
    ...
    def getRandomColor(self):
        sumL = len(self.canUseRGB)-1
        randomColor = lambda:(self.canUseRGB[random.randint(0,sumL)],self.canUseRGB[random.randint(0,sumL)],self.canUseRGB[random.randint(0,sumL)])
...
if __name__ == '__main__':
    ...
    workPath = "D:/pythonWorkSpaces/pythonlib/MyPythonLib/Util/datas/colorFill"
    os.chdir(workPath)
